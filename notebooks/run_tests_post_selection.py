...
# MAGIC %md
# MAGIC # insurance-gam post_selection test runner
# MAGIC
# MAGIC Runs the full test suite including the new post_selection module.
# MAGIC Tests: PostSelectionGLM, DataSplitPostSelectionGLM, input validation,
# MAGIC exposure offsets, forest_plot, and all pre-existing tests.
