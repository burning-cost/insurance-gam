...
# MAGIC %md
# MAGIC # insurance-gam PenalizedGLMInference test runner
# MAGIC
# MAGIC Runs the full test suite including the new PenalizedGLMInference module.
# MAGIC Tests cover: Poisson/Gamma/Tweedie families, asymptotic debiased CIs (Strategy A),
# MAGIC Pearson residual bootstrap CIs (Strategy B), exposure offsets, input validation,
# MAGIC forest_plot, summary(), and all pre-existing GLM inference tests.
